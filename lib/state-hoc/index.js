...
var stateHOC = function stateHOC() {
    var initHocParams = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    var hocParams = Object.assign({}, {
            ...
            _createClass(StateContainer, [{
                ...
                value: function showView(fetchStatus) {
                    var height = hocParams.height,
                        LoadingView = hocParams.LoadingView,
                        FailureView = hocParams.FailureView,
                        ErrorView = hocParams.ErrorView;
